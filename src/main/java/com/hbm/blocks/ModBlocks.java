...
public class ModBlocks {
	...
	//Kork custom ores
	public static Block ore_ilmenite;
	...
	private static void initializeBlock() {
		...
		//Kork blocks :3
		ore_ilmenite = new BlockOre(Material.iron).setBlockName("ore_ilmenite").setCreativeTab(MainRegistry.blockTab).setHardness(2.5F).setResistance(10.0F).setBlockTextureName(RefStrings.MODID + ":ore_ilmenite");
	...
	private static void registerBlock() {
		...
		//Kork ores n blocks
		GameRegistry.registerBlock(ore_ilmenite, ItemBlockBase.class, ore_ilmenite.getUnlocalizedName());
