...
public class ModItems {
	...
	public static void initializeItem() {
		...
		//kork items
		powder_ilmenite = new Item().setUnlocalizedName("powder_ilmenite").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_ilmenite");
	...
	private static void registerItem() {
		...
		//Kork Items
		GameRegistry.registerItem(powder_ilmenite, powder_ilmenite.getUnlocalizedName());
