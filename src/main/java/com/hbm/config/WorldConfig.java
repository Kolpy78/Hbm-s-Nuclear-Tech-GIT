...
public class WorldConfig {
	...
	//Kork config
	public static int ilmeniteSpawn = 12;
	...
	public static void loadFromConfig(Configuration config) {
		...
		ilmeniteSpawn = CommonConfig.createConfigInt(config, CATEGORY_OREGEN, "2.32_ilmeniteSpawnrate", "Amount of ilmenite ore veins per chunk", 12);
