...
public class ChemicalPlantRecipes extends GenericRecipes<GenericRecipe> {
	...
	public void registerDefaults() {
		...
		/// KORK ///
		this.register(new GenericRecipe("chem.titanium_chlorination").setup(100, 1000).setIcon(ModItems.fluid_icon, Fluids.TITANIUMTETRACHLORINE.getID())
			.inputItems(new ComparableStack(ModItems.powder_ilmenite, 1), new ComparableStack(ModItems.powder_coal, 1))
			.inputFluids(new FluidStack(Fluids.CHLORINE, 400))
			.outputFluids(new FluidStack(Fluids.TITANIUMTETRACHLORINE, 400), new FluidStack(Fluids.CARBONDIOXIDE, 200)));

		this.register(new GenericRecipe("chem.Krypton_from_air_extraction").setup(500, 1500).setIcon(ModItems.fluid_icon, Fluids.KRYPTON.getID())
			.inputFluids(new FluidStack(Fluids.NONE, 0))
			.outputFluids(new FluidStack(Fluids.KRYPTON, 100)));

		this.register(new GenericRecipe("chem.Titanium_tetrachloride_reduction").setup(150, 1000).setIcon(ModItems.ingot_titanium)
			.inputFluids(new FluidStack(Fluids.TITANIUMTETRACHLORINE, 375), new FluidStack(Fluids.KRYPTON, 100))
			.inputItems(new ComparableStack(ModItems.powder_sodium, 1))
			.outputItems(new ItemStack(ModItems.powder_titanium, 1)));
	}
